...
public function vdolist_Action($id){
    ...
    return $this->render('AcmeHelloBundle:Default:show_all_vdos.html.twig', 
				array('utubelink_id'=>$qryforutube, 'piclist'=>$qryresult, 'qutube'=>$vidarray, 'qtube'=>$vdocode,'vmsg'=>$v, 'vedio'=>$videopath));
...
public function advance_search_criteria_Action(Request $request)
{
        ...
        {	
			...
			else
			{
				...
				*/
				...
				// final return
				return $this->render('AcmeHelloBundle:Default:advanced_search_criteria.html.twig',
							array('bedrooms' => $bedroom, 'ranze'=>$price, 'lndry'=>$laundry, 'bath'=>$bath,'bb'=>$bedcombotxt , 
	...
	return $this->render('AcmeHelloBundle:Default:advanced_search_criteria.html.twig',
						array('bedrooms' => $bedroom, 'ranze'=>$price, 'lndry'=>$laundry, 'bath'=>$bath, 'bb'=>'', 
...
public function memberAction($id) 
{
	...
	return $this->render('AcmeHelloBundle:Default:user.html.twig', 
					array('bb'=>$srch , 'aa'=>$total_poster, 'de'=>$kode, 'poster_id'=>$srch_list_ofposter));
}
...
{	
	...
	return $this->render('AcmeHelloBundle:Default:listofvdosbyposterid.html.twig', 
					array('poster_id'=>$qryforutube, 'psnum'=>$id, 'utubelink_id'=>$qryforutube, 
...
{	
	...
	return $this->render('AcmeHelloBundle:Default:listofpicturesbyposterid.html.twig', 
					array('poster_id'=>$srch_list_ofpictures, 'psnum'=>$id));
}
